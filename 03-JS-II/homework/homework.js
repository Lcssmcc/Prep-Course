...
function estaEnRango(numero) {
  ...
  if (numero > 20.0 && numero < 50.0) return true
    else return false
...
function tablaDelSeis(){
  ...
  do {
    tabla.push(inicial * 6)
    inicial++
    //console.log(inicial)
    //console.log(tabla[inicial -1])
...
function doWhile(numero) {
  ...
  do {
	  //console.log("El valor es: " + numero1);
	  numero1 +=5 ;
  } while (numero1 < (numero+40));
  return numero1
